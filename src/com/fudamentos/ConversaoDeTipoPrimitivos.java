...
public class ConversaoDeTipoPrimitivos {
        ...
        public static void main(String[] args) {
                ...
                int d = 4;
                byte e = (byte) d; // é necessario ter cuidado nas converções explicitas pois o tamanho do tipo a
                                   // ser convertido
                // pode afetar o valor, nesse caso o valor de "d" não pode ser maior que 127,
                // pois o valor na conversão seria quebrado.

                // Convertendo valores com pontos flutuantes
                double f = 1.999999;
                int g = (int) f;
                // nesse cenário é delicadado, pois no momento da conversão para int as casas
                // decimais são
                // completamente ignoradas na conversão, o ideal a ser passado como valor seria
                // 2, porém, as casas são ignoradas.
                ...
                // é retonardo um numero com muitas casas decimais pois é usado um algortimo não
                // tão preciso para calcular os numeros
