...
public class Fila {
        ...
        public static void main(String[] args) {
                ...
                // Caso ocorra um eror ao adicionar o elemento na fila offer ira retornar um
                // boolean informando
                // true = adicionado, false = não adicionado
                // nao remove o elemnto da fila ao retornar
                fila.offer("Ana2");

                // retorma o primeiro elamento da fila, caso a fila esteja vazia o valor sera
                // null
                fila.peek();
                // retorma o primeiro elamento da fila, caso a fila esteja vazia lançara uma
                // exceção
