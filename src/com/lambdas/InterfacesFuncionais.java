...
public class InterfacesFuncionais {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> function = (String s) -> s
                + " , recebe um parametro do tipo e retorna um valor do tipo especificado";
        System.out.println(function.apply("function"));

        Predicate<String> predicate = (String s) -> s.length() > 0;
        System.out.println(
                "Predicate, recebe um parametro do tipo e retorna um valor booleano. " + predicate.test("Predicate"));
